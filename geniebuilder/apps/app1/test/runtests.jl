...
# !!! Main.UserApp is configured as an alias for Main.App1 and you might encounter it in some tests
using Main.App1, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "App1 tests" begin
  @includetests ARGS
end
